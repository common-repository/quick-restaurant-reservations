...
global $qrr_email;
$header_img = $qrr_email['header_img'];
$heading = $qrr_email['heading'];
    ...
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tr>
            <td align="center" valign="top">
                <?php if(! empty($header_img) && QRR_Active('capacity') ) : ?>
                    <div id="template_header_image">
                        <?php echo '<p style="margin-top:0;"><img style="max-width: 150px;" src="' . esc_url($header_img) . '" alt="' . get_bloginfo('name') . '" /></p>'; ?>
                    </div>
                <?php endif; ?>
                <table border="0" cellpadding="0" cellspacing="0" width="520" id="template_container" style="<?php echo esc_attr($template_container); ?>">
                    <?php if (! empty($heading) ) : ?>
                        <tr>
                            <td align="center" valign="top">
                                <!-- Header -->
                                <table border="0" cellpadding="0" cellspacing="0" width="520" id="template_header" style="<?php echo esc_attr($template_header); ?>" bgcolor="#ffffff">
                                    <tr>
                                        <td>
                                            <h1 style="<?php echo esc_attr($header_content_h1); ?>"><?php echo wpautop(wp_kses_post(wptexturize($heading))); ?></h1>
                                        </td>
                                    </tr>
                                </table>
                                <!-- End Header -->
